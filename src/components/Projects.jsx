...
const defaultProjects = [
  ...
  {
    title: "Kengos",
    desc: "An innovative footwear brand platform engineered for eco-friendly comfort and sustainable lifestyle design.",
    img: Project6,
  },
];
...
const Projects = () => {
  ...
  const headerSubtitle = projectsData?.headerSubtitle || "My";
  const headerHighlight = projectsData?.headerHighlight || "Projects";
  const mainHeading = projectsData?.mainHeading || "Some of my recent work!";
  const projectsList = projectsData?.projectsList?.length ? projectsData.projectsList : defaultProjects;
  const copyrightText = projectsData?.copyrightText || "© Pyush Anand 2026.";
